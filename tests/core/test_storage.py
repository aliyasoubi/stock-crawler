...
from stock_crawler.core.storage import RawStore, RunLock, RunLocked, SnapshotMissing, StateStore, StorageError, combined_content_hash
...
def test_run_lock_is_released_when_owner_process_dies(tmp_path):
    ...
    source = "from pathlib import Path; import os; from stock_crawler.core.storage import RunLock; lock=RunLock(Path(__import__('sys').argv[1])); lock.acquire(); os._exit(0)"
